...
#ifndef PERSHYANCOIN_TEST_SCRIPTNUM10_H
#define PERSHYANCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Pershyancoin Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // PERSHYANCOIN_TEST_BIGNUM_H
