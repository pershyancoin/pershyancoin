 ...
 * between pershyancoind, and pershyancoin-qt and non-server tools.
*/
...
void Shutdown()
{
    ...
    RenameThread("pershyancoin-shutoff");
...
#ifndef WIN32
    strUsage += HelpMessageOpt("-pid=<file>", strprintf(_("Specify pid file (default: %s)"), PERSHYANCOIN_PID_FILENAME));
#endif
...
void ThreadImport(std::vector<fs::path> vImportFiles)
{
    ...
    RenameThread("pershyancoin-loadblk");
...
/** Sanity checks
 *  Ensure that Pershyancoin is running in a usable environment with all
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("Pershyancoin version %s\n", FormatFullVersion());
}
...
static bool LockDataDirectory(bool probeOnly)
{
    ...
    // Make sure only a single Pershyancoin process is using the data directory.
...
bool AppInitMain(boost::thread_group& threadGroup, CScheduler& scheduler)
{
    ...
    LogPrintf("Using config file %s\n", GetConfigFile(gArgs.GetArg("-conf", PERSHYANCOIN_CONF_FILENAME)).string());
