...
#if defined(NDEBUG)
# error "Pershyancoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Pershyancoin Signed Message:\n";
...
void ThreadScriptCheck() {
    RenameThread("pershyancoin-scriptch");
