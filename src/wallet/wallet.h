...
#ifndef PERSHYANCOIN_WALLET_WALLET_H
#define PERSHYANCOIN_WALLET_WALLET_H
...
public:
     ...
     * on this pershyancoin node, and set to 0 for transactions that were created
...
#endif // PERSHYANCOIN_WALLET_WALLET_H
