...
#ifndef PERSHYANCOIN_QT_SENDCOINSDIALOG_H
#define PERSHYANCOIN_QT_SENDCOINSDIALOG_H
...
/** Dialog for sending pershyancoins */
...
#endif // PERSHYANCOIN_QT_SENDCOINSDIALOG_H
