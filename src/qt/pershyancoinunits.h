...
#ifndef PERSHYANCOIN_QT_PERSHYANCOINUNITS_H
#define PERSHYANCOIN_QT_PERSHYANCOINUNITS_H
...
/** Pershyancoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class PershyancoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit PershyancoinUnits(QObject *parent);

    /** Pershyancoin units.
      @note Source: https://en.pershyancoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        PSC,
...
typedef PershyancoinUnits::Unit PershyancoinUnit;

#endif // PERSHYANCOIN_QT_PERSHYANCOINUNITS_H
