...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<PershyancoinAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_pershyancoin-qt -platform xcb      # Linux
//     src/qt/test/test_pershyancoin-qt -platform windows  # Windows
//     src/qt/test/test_pershyancoin-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = PershyancoinUnits::formatWithUnit(unit, balance, false, PershyancoinUnits::separatorAlways);
    ...
    // Amount input
    PershyancoinAmountField* amountInput = receiveCoinsDialog.findChild<PershyancoinAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: pershyancoin:")) != -1);
