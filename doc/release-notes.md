...
Pershyancoin Core version *version* is now available from:

  <https://pershyancoin.org/bin/pershyancoin-core-*version*/>
...
GCC 4.8.x
--------------
The minimum version of GCC required to compile Pershyancoin Core is now 4.8. No effort will be
