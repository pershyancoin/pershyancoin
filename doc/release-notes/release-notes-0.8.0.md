Pershyancoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/pershyancoin/files/Pershyancoin/pershyancoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Pershyancoin
...
New/changed settings (command-line or pershyancoin.conf file)
--------------------------------------------------------
