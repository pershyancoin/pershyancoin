...
- #8153 `75ec320` `fundrawtransaction` feeRate: Use PSC/kB (MarcoFalke)
...
- #8207 `f7a403b` Add a link to the Pershyancoin-Core repository and website to the About Dialog (MarcoFalke)
...
- #8047 `37f9a1f` Test_framework: Set wait-timeout for pershyancoind procs (MarcoFalke)
...
- #7975 `fc23fee` Update pershyancoin-core GitHub links (MarcoFalke)
