Pershyancoin Core version 0.10.4 is now available from:

  <https://pershyancoin.org/bin/pershyancoin-core-0.10.4/>
...
- #6953 `43c2789` Split pershyancoin-tx into its own package
- #6953 `dfe0d4d` Include pershyancoin-tx binary on Debian/Ubuntu
