Pershyancoin Core version 0.13.2 is now available from:

  <https://pershyancoin.org/bin/pershyancoin-core-0.13.2/>
...
- #8932 `106da69` Allow pershyancoin-tx to create v2 transactions (pscdrak)
