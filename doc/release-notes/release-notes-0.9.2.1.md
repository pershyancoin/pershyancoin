Pershyancoin Core version 0.9.2.1 is now available from:

  https://pershyancoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 PSC to 0.01 PSC
...
- Fix "Start pershyancoin on system login"
