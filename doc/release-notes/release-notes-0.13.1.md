Pershyancoin Core version 0.13.1 is now available from:

  <https://pershyancoin.org/bin/pershyancoin-core-0.13.1/>
...
- **Elimination of unwanted transaction malleability:** Segregating the witness
  ...
  malleability, which is a problem that makes programming Pershyancoin wallet
  software more difficult and which seriously complicates the design of smart
  contracts for Pershyancoin.
...
- **Weighting data based on how it affects node performance:** Some parts of
  each Pershyancoin block need to be stored by nodes in order to validate future
...
- **Signature covers value:** A simple improvement in the way signatures are
  ...
  of pershyancoins they think they are spending, and by having full nodes refuse to
  accept those signatures unless the amount of pershyancoins being spent is exactly
...
- **Increased security for multisig:** Pershyancoin addresses (both P2PKH addresses
  ...
  believed to be provided by Pershyancoin's choice of parameters for its Elliptic
  Curve Digital Security Algorithm [ECDSA].)

- **More efficient almost-full-node security** Satoshi Nakamoto's original
  Pershyancoin paper describes a method for allowing newly-started full nodes to
  skip downloading and validating some data from historic blocks that are
  protected by large amounts of proof of work.  Unfortunately, Nakamoto's
  method can't guarantee that a newly-started node using this method will
  produce an accurate copy of Pershyancoin's current ledger (called the UTXO set),
  ...
  note that Pershyancoin Core does not provide an option to use this capability as
  of this 0.13.1 release.

- **Script versioning:** Segwit makes it easy for future soft forks to allow
  Pershyancoin users to individually opt-in to almost any change in the Pershyancoin
  Script language when those users receive new transactions.  Features
  currently being researched by Pershyancoin Core contributors that may use this
  capability include support for Schnorr signatures, which can improve the
  privacy and efficiency of multisig transactions (or transactions with
  multiple inputs), and Merklized Abstract Syntax Trees (MAST), which can
  improve the privacy and efficiency of scripts with two or more conditions.
  Other Pershyancoin community members are studying several other improvements
...
[Segwit FAQ]: https://pershyancoincore.org/en/2016/01/26/segwit-benefits/
[segwit wallet developers guide]: https://pershyancoincore.org/en/segwit_wallet_dev/
[BIP141]: https://github.com/pershyancoin/bips/blob/master/bip-0141.mediawiki
[BIP143]: https://github.com/pershyancoin/bips/blob/master/bip-0143.mediawiki
[BIP144]: https://github.com/pershyancoin/bips/blob/master/bip-0144.mediawiki
[BIP145]: https://github.com/pershyancoin/bips/blob/master/bip-0145.mediawiki
[versionbits FAQ]: https://pershyancoincore.org/en/2016/06/08/version-bits-miners-faq/
...
Since Pershyancoin Core 0.10.0, nodes have defaulted to only relaying and
...
[BIP147]: https://github.com/pershyancoin/bips/blob/master/bip-0147.mediawiki
...
- #8848 `7a34a46` Add NULLDUMMY verify flag in pershyancoinconsensus.h (jl2012)
...
- #8940 `5b4192b` Add x9 service bit support to dnsseed.bluematt.me, seed.pershyancoinstats.com (TheBlueMatt, cdecker)
- #8944 `685e4c7` Remove bogus assert on number of oubound connections. (TheBlueMatt)
- #8949 `0dbc48a` Be more agressive in getting connections to peers with relevant services (gmaxwell)

### Build system
- #8293 `fa5b249` Allow building libpershyancoinconsensus without any univalue (luke-jr)
- #8492 `8b0bdd3` Allow building bench_pershyancoin by itself (luke-jr)
