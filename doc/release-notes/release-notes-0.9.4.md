Pershyancoin Core version 0.9.4 is now available from:

  https://pershyancoin.org/bin/0.9.4/
...
this update is incompatible with the Pershyancoin system and could lead to consensus
forks.

Pershyancoin Core released binaries from https://pershyancoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~pershyancoin/+archive/ubuntu/pershyancoin
- A third-party or self-compiled Pershyancoin Core

upgrade to Pershyancoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
