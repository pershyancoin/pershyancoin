Pershyancoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/pershyancoin/files/Pershyancoin/pershyancoin-0.5.4/
...
http://gitorious.org/pershyancoin/pershyancoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Pershyancoin-Qt notifications under Growl 1.3.
Increase required age of Pershyancoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxPershyancoin properly when installing Pershyancoin-Qt over it. (Windows)
