Download URL: https://sourceforge.net/projects/pershyancoin/files/Pershyancoin/pershyancoin-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 PSC fee schedule (users still pay 0.01 PSC per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #pershyancoin00 - #pershyancoin99
