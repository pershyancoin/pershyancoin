...
This document provides guidelines for internationalization of the Pershyancoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `pershyancoin_en.ts` remains unchanged.
