...
# TestNode: A peer we use to send messages to pershyancoind, and store responses.
...
class CompactBlocksTest(PershyancoinTestFramework):
    ...
    # This test actually causes pershyancoind to (reasonably!) disconnect us, so do this last.
    ...
    # pershyancoind's choice of nonce.
    ...
    # Test that pershyancoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for pershyancoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # pershyancoind will not send blocktxn responses for blocks whose height is
