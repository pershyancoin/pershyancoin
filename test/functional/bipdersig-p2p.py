...
class BIP66Test(PershyancoinTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # pershyancoind is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and pershyancoind produces more specific reject
            # reasons.
